...
/**
 * Data class representing a border with a specified stroke width and color.
 *
...
/**
 * Applies custom borders to the specified sides of a Composable.
 *
 * @param start Border to be drawn on the start (left) side. Defaults to null.
 * @param top Border to be drawn on the top side. Defaults to null.
 * @param end Border to be drawn on the end (right) side. Defaults to null.
 * @param bottom Border to be drawn on the bottom side. Defaults to null.
 */
@Stable
fun Modifier.border(
    start: Border? = null,
